<script lang="ts">
	...
	// Sizes: map from size -> stock count string
		...
		<div class="form-main">
			...
			<section class="form-section">
				...
				<FormField label="Description">
					<textarea class="input textarea" bind:value={description} placeholder="Describe this piece..." rows="4"></textarea>
				</FormField>
				<div class="field-row">
				...
				<div class="field-row">
					<FormField label="Price (USD)" required>
						<div class="input-prefix-wrap">
							...
							<input class="input with-prefix" type="number" min="0" step="0.01" bind:value={priceDollars} placeholder="55.00" />
						</div>
					</FormField>
					<FormField label="Compare At Price (optional)">
						<div class="input-prefix-wrap">
							<span class="input-prefix">$</span>
							<input class="input with-prefix" type="number" min="0" step="0.01" bind:value={compareAtPriceDollars} placeholder="65.00" />
						</div>
					</FormField>
				</div>
			</section>
			...
			<section class="form-section">
				...
				<p class="section-hint">Click a size to add it, then set the stock count.</p>
				<div class="size-chips">
					{#each ALL_SIZES as size}
						<button
							class="size-chip"
							class:active={size in selectedSizes}
