<script lang="ts">
	...
	import { getTagHex, getCategoryLabel, type MediaTag, type TagColor, type TagCategory } from '$lib/types/media';
	...
	function handleCategorySelect(category: TagCategory) {
...
>
	...
	{#if showCategoryPicker}
		<div class="inline-panel">
			<TagManagerCategoryPicker selected={tag.category} onselect={handleCategorySelect} />
		</div>
	{/if}
</div>
